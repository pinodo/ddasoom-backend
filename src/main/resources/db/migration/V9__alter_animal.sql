-- =============================================
-- animal: deleted_at이 쓰일 일이 없음
-- =============================================
-- API data는 지울 일이 없어서 deleted_at 컬럼이 필요 없음.
-- (DB 컨벤션 §5 "물리 DELETE 금지 / soft delete"의 팀 합의 예외 — animal_like, animal 한정)
--
...
ALTER TABLE `animal` DROP COLUMN `deleted_at`;